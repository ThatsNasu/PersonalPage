...
<section
	id="header"
	class="border-neutral border-accent-foreground fixed top-0 z-50 flex w-full items-center justify-between gap-1 border-b p-4 px-6"
>
	<a href="/">ThatsNasu</a>
	<nav class="flex items-center gap-1">
		...
		<Button
			variant="ghost"
			size="icon"
			href="https://github.com/thatsnasu"
			target="_blank"
...
<footer class="flex flex-col justify-around gap-2 p-4 text-white sm:flex-row">
	<aside>
		<Button
			variant="ghost"
			size="icon"
	...
	<nav>
		...
		<Button
			...
			target="_blank"
			rel="noopener noreferer"
			href="https://bitbite.dev">bitbite</Button
		>
		<Button
			variant="link"
			size="link"
			...
			target="_blank"
			rel="noopener noreferer"
			href="https://netcode.dev">netcode</Button
		>
	</nav>
	<nav>
